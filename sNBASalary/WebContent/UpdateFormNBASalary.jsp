...
<body>
	<form action="umember.do" method="GET" enctype="multipart/form-data">
		<fieldset>
			<legend style="text-align: center; font-size: 50px">更新球員資料</legend>
			<div class="qoo">
			...
			<div class="qoo">
				<label class="qz">位置:</label> <label class="qc"> <input
			...
			<div class="qoo">
				<label class="qq">薪資(USD):</label> <input type="number"
					name="insalary" min="1" max="999999999" size="100px">
			</div>
			<div class="qoo">
