...
@WebServlet("/Dmember.do")
public class DeleteProcessMemberServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher("DeleteNBASuccess.jsp");
